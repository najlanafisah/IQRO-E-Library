    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border border-black shadow-sm">
                <div class="card-header border-bottom border-black bg-yellow fw-semibold py-3 text-center">{{ __('LOGIN') }}</div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="text-black small ms-3" href="{{ route('password.request') }}">
